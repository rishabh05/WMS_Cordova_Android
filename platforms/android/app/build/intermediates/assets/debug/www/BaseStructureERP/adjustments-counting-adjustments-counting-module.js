        ...
        this.phycountService.ShowBILOTList(this.ItemCode, this.BinNo).subscribe(function (data) {
            ...
            if (data != undefined) {
                ...
                if (data.length > 0) {
                    ...
                    _this.toastr.error('', _this.translate.instant("PhyCount_BinTransfer.NoData"));
                }
            }
            else {
                _this.toastr.error('', _this.translate.instant("PhyCount_BinTransfer.NoData"));
        ...
        this.phycountService.getItemInfo(this.ItemCode, this.DocNo, this.DocEntry).subscribe(function (data) {
            ...
            if (data != null) {
                if (data.length > 0) {
                    ...
                    _this.toastr.error('', _this.translate.instant("PhyCount_GoodsIssue.INVALIDITEM"));
                    _this.ItemCode = "";
                    _this.ItemName = "";
                    _this.ItemTracking = "";
                }
            ...
            if (data != null) {
                if (data.length > 0) {
                    ...
                    if (data[0].ErrorMsg == "" && data[0].Successmsg != "") {
                        _this.toastr.success('', _this.translate.instant("PhyCount_DocUpdatedSucessfullyMsg") + " " + _this.DocEntry);
                        _this.clearData();
