        ...
        this.productionService.submitProductionRecepit(requestData).subscribe(function (data) {
            ...
            if (data != undefined) {
                ...
                if (data[0].ErrorMsg == "" && data[0].Successmsg == "SUCCESSFULLY") {
                    ...
                    _this.toastr.success('', _this.translate.instant("ProdReceipt_FGRSuccessMessage") + " " + data[0].SuccessNo);
        ...
        if (this.showRejectQtyField == true && this.model.options == '2') {
            ...
            if (this.tracking == "N") {
                ...
                if (this.checkIfSerialBatchAlreadyExists(this.serialBatchNo) == true) {
                    if (this.tracking == "B") {
                        this.toastr.error('', this.translate.instant("ProdReceipt_BatchAlreadyExists"));
                    }
                    if (this.tracking == "S") {
    ...
    ProductionReceiptComponent.prototype.checkAndValidateSerial = function () {
        ...
        this.checkValidateSerialSubs = this.productionService.isSerialExists(this.serialBatchNo, this.itemCode, type, this.tracking, this.orderNumber).subscribe(function (data) {
            if (data != undefined) {
                ...
                if (data == "1") {
                    //error message
                    _this.toastr.error('', _this.translate.instant("ProdReceipt_SerialNoAlreadyUsed"));
                    _this.serialBatchNo = "";
                    return;
                }
                else if (data == "2") {
                    _this.toastr.error('', _this.translate.instant("ProdReceipt_InvalidBatchSerial"));
                    _this.serialBatchNo = "";
                    return;
                }
                else {
