...
var InboundDetailsComponent = /** @class */ (function () {
    ...
    InboundDetailsComponent.prototype.SubmitGoodsReceiptPO = function (oSubmitPOLotsObj) {
        ...
        this.inboundService.SubmitGoodsReceiptPO(oSubmitPOLotsObj).subscribe(function (data) {
            ...
            if (data[0].ErrorMsg == "" && data[0].Successmsg == "SUCCESSFULLY") {
                ...
                _this.toastr.success('', _this.translate.instant("Inbound_GRPOSuccessMessage") + " " + data[0].SuccessNo);
    ...
    InboundDetailsComponent.prototype.OnVendorChange = function () {
        ...
        this.inboundService.IsVendorExists(this.VendCode).subscribe(function (data) {
            ...
            if (data != null) {
                ...
                if (data[0].Result == "0") {
                    _this.toastr.error('', _this.translate.instant("Inbound_VendorExistMessge"));
                    _this.VendCode = "";
    ...
    InboundDetailsComponent.prototype.onInboundScan = function () {
        // alert("scan click");
    };
    InboundDetailsComponent.prototype.onHiddenScanClick = function () {
        this.onGS1ItemScan();
    };
    InboundDetailsComponent.prototype.onGS1ItemScan = function () {
        ...
        this.inboundService.getRevBins(this.openPOLineModel[0].QCREQUIRED).subscribe(function (data) {
            ...
            if (data != null) {
                if (data.length > 0) {
                    ...
                    _this.toastr.error('', _this.translate.instant("Inbound_NoBinsAvailableMsg"));
                }
            }
        }, function (error) {
            _this.showLoader = false;
...
module.exports = ".color-label {\n  padding: 0;\n  margin: 0 0 10px 0;\n  display: flex;\n  align-items: center;\n  align-self: center;\n  justify-self: flex-end;\n  justify-content: flex-end; }\n\n.color-label li {\n  display: flex;\n  align-items: center; }\n\n.color-label li span.color-block {\n  display: inline-block;\n  width: 18px;\n  height: 18px;\n  border: 1px solid #bfbfbf;\n  margin-right: 10px; }\n\n.color-label li span.color-block + span {\n  padding-right: 10px;\n  color: #666; }\n\n.color-label li span.red {\n  background-color: #ffcece; }\n\n.color-label li span.blue {\n  background-color: #b6def9; }\n\n.color-label li span.green {\n  background-color: #b6f9c4; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var InboundPolistComponent = /** @class */ (function () {
        ...
        this.inboundService.IsPOExists(this.poCode, "").subscribe(function (data) {
            ...
            if (data != null) {
                if (data.length > 0) {
                    ...
                    _this.poCode = "";
                    _this.toastr.error('', _this.translate.instant("Inbound_POExistMessage"));
                    return;
                }
            }
            else {
    ...
    InboundPolistComponent.prototype.onInboundScan = function () {
        // alert("scan click");
    };
    InboundPolistComponent.prototype.onHiddenScanClick = function () {
        this.onGS1ItemScan();
    };
    InboundPolistComponent.prototype.onGS1ItemScan = function () {
        var inputValue = document.getElementById('inboundScanInputField').value;
        if (inputValue.length > 0) {
            this.poCode = inputValue;
        }
    };
    InboundPolistComponent.prototype.onItemHiddenScanClick = function () {
        this.onGS1ItemScan1();
    };
    InboundPolistComponent.prototype.onGS1ItemScan1 = function () {
        var inputValue = document.getElementById('inboundScanInputField').value;
        if (inputValue.length > 0) {
